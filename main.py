...
GIF_FPS = int(os.environ.get("GIF_FPS", "5"))
GIF_WIDTH = int(os.environ.get("GIF_WIDTH", "720"))
GIF_MAX_SECONDS = int(os.environ.get("GIF_MAX_SECONDS", "12"))  # cap clip length we transcode
